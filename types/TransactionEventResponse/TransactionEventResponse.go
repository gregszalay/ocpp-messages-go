...
type TransactionEventResponseJson struct {
	...
	//
	//
	TotalCost *float64 `json:"totalCost,omitempty" yaml:"totalCost,omitempty"`

	// UpdatedPersonalMessage corresponds to the JSON schema field
	// "updatedPersonalMessage".
	UpdatedPersonalMessage *MessageContentType `json:"updatedPersonalMessage,omitempty" yaml:"updatedPersonalMessage,omitempty"`
}
